...
Public Class EditExistingHouse
    ...
    Private Sub MetroButton1_Click(sender As Object, e As EventArgs) Handles MetroButton1.Click
        If executeQuery("SELECT * FROM tbl_housedesc WHERE id = '" & MetroTextBox1.Text & "'") Then
            setHouseDesign("SELECT * FROM tbl_housedesc WHERE id = '" & MetroTextBox1.Text & "'")
        Else
            MessageBox.Show("House not found!", "Status", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub

    Sub setHouseDesign(query)
        Try
            ...
            If reader.Read Then
                ...
                MessageBox.Show("House Information Found!", "Status", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
            connection.Close()
