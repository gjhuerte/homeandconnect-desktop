    ...
    Private Sub MetroButton1_Click_1(sender As Object, e As EventArgs) Handles MetroButton1.Click
        ...
        Else
            If isPasswordCorrect() Then
                ...
                If executeQuery("call sproc_insertuser('" & MetroTextBox1.Text &
                 "','" & MetroTextBox2.Text & "','" & MetroTextBox3.Text &
                 "','" & email & "','" & cellno &
                 "','" & bday & "','" & gender & "','" & MetroTextBox8.Text & "','" & MetroTextBox6.Text & "','" & type & "')") Then
                    MessageBox.Show("Account successfully created!", "Status",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Timer1.Stop()
                    Me.Close()
                Else
                    MessageBox.Show("There is a problem in creating your account!", "Status",
