...
Public Class AddNewBilling
    ...
    Private Sub MetroDateTime1_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles MetroDateTime4.Validating, MetroDateTime3.Validating, MetroDateTime1.Validating
        If Not DateTime.Compare(Now, sender.value) >= 0 Then
            sender.value = Now
            MessageBox.Show("Due date must be greater than current date!", "Status", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
End Class