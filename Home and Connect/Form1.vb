...
Public Class Form1
    ...
    Private Sub MetroButton1_Click(sender As Object, e As EventArgs) Handles MetroButton1.Click
        If MetroButton1.Text = "Search" Then
            setData()
        Else
            If executeQuery("call deleteBillingInfo('" & MetroTextBox1.Text & "')") Then
                MessageBox.Show("Successfully deleted billing information", "Status", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
                MessageBox.Show("Billing ID does not exist!", "Status", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
        End If
    End Sub
